      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex-shrink-0">
            <Link to="/account" className="text-2xl font-bold text-indigo-600">
              AccountManager Pro
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="bg-red-500 text-white px-3 py-1 rounded-md text-sm font-medium hover:bg-red-600 transition duration-150 shadow-sm"
            >
              Logout
            </button>
          </div>
